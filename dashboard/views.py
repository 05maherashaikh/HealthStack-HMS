...
def dashboard_hms_ai(request):
    if request.method == 'POST':
        ...
        final_query = f'''
        You are the AI chatbot inside a website called HospitalSys.
        Your responsibility is to answer questions ONLY about HospitalSys data.
        If question is outside this, say: "I can only answer HospitalSys-related queries."
